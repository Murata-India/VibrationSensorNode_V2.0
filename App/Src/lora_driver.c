...
GPIO_TypeDef* LED_PORT[LEDn] = {LED_CNTRL_GPIO_Port};

const uint16_t LED_PIN[LEDn] = {LED_CNTRL_Pin};
...
void Lora_fsm(void)
{
  ...
  switch (DeviceState)
  {
    ...
    case DEVICE_READY:
    {
      //BSP_LED_On(LED1);				   /* Led on Nucleo Master device to indicate a Join request*/
    ...
    case DEVICE_JOINED:
    {
      //DBG_PRINTF("Nwk Joined - Initializing timer\n");
      /*Schedule the first measure */
    ...
    case DEVICE_SEND:
    {
        ...
        //BSP_LED_On(LED1);/* Led on Nucleo Master device to indicate a send request*/
